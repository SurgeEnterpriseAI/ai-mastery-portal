    ...
    <main className="grid min-h-screen place-items-center px-6">
      <div className="w-full max-w-md animate-fadein rounded-2xl border border-slate-200 bg-white p-8 shadow-card">
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-slate-900">Trainer Sign-in</div>
        ...
        <p className="mt-6 rounded-lg bg-slate-50 p-3 text-xs text-slate-500">
          For Tensorpath trainers only. Learners don&rsquo;t sign in here — they <Link href="/join" className="text-brand-600 hover:underline">enrol in the program</Link>. Forgot your credentials? Contact your admin.
        </p>
      </div>
    </main>
  );

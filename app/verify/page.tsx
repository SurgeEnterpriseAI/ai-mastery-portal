  ...
  return (
    <main className="grid min-h-screen place-items-center px-6">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center">
        ...
        <div className="mt-3 text-xs uppercase tracking-widest text-brand-600">Tensorpath · by Surge Software</div>
        <h1 className="mt-2 text-2xl font-extrabold text-slate-900">Verify a credential</h1>
        <p className="mt-2 text-sm text-slate-500">
          Enter the credential ID from a Tensorpath certificate to confirm it&rsquo;s genuine and see the holder&rsquo;s capstone project.
        </p>
        <VerifyLookup />
      </div>
    </main>

  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-12">
      ...
      <section className="mt-16 animate-fadein">
        <p className="font-semibold text-brand-600">Surge Software · upskilling people on AI · 20 days · fundamentals → the 2026 frontier</p>
        ...
        <p className="mt-5 max-w-3xl text-lg text-slate-600">
          Surge Software&rsquo;s flagship program for training professionals and students on AI — at scale. A guided
          20-day journey from the very first Transformer to today&rsquo;s reasoning models, multimodal systems, and
          agents. You learn <strong>live with a Surge trainer</strong> and a <strong>personal AI coach</strong> that
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <Stat label="Delivered by" value="Surge" />
        </div>
      </section>
      ...
      <section className="mt-16">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          ...
          <Step n="2" title="Learn live + with your AI coach" body="A Surge trainer presents each day live; between sessions your AI coach answers questions, gives scenarios, and tells you what to learn next." />
      ...
      <section className="mt-16" data-tour="arc">
        ...
        <p className="mt-1 text-slate-500">Every day is a complete, story-driven lesson your Surge trainer delivers live — and you can revisit any time.</p>
      ...
      <footer className="mt-16 flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-6 text-sm text-slate-400">
        <span>Surge Software · AI Academy — upskilling professionals &amp; students on AI, end to end.</span>
        <span className="flex gap-4">
          <Link href="/verify" className="text-brand-600 hover:underline">Verify a credential</Link>
          <Link href="/login" className="text-slate-400 hover:text-slate-700">Surge trainer sign-in</Link>
        </span>
      </footer>

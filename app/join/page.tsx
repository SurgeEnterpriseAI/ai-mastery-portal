    ...
    <main className="grid min-h-screen place-items-center px-6 py-10">
      <div className="w-full max-w-lg animate-fadein rounded-2xl border border-slate-200 bg-white p-8 shadow-card">
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-slate-900">Start your AI journey</div>
            <div className="text-xs text-slate-500">Get a personal AI coach · first 3 sessions free</div>
          </div>
        </div>
        <JoinForm />
